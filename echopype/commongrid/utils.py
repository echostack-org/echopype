...
def ping_time_bin_parsing_and_conversion(ping_time_bin: str):
    """
    Convert a time bin string into a numeric value and normalized unit label.

    Parameters
    ----------
    ping_time_bin : str
        Time duration string compatible with pandas.

    Returns
    -------
    ping_time_bin_resvalue : int
        The numeric value of the time bin.
    ping_time_bin_resunit_label : str
        The corresponding unit label (e.g., "second", "minute", "hour").
    """
